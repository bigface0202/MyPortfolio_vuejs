      ...
      works: [
        {
          ...
          assets: 'Flutter',
          description: 'Flutterで初めて作ったアプリです。筋トレを行った部位のメモを取ることができます。部位のみを記録する簡素化されたアプリです。行った部位のボリュームをグラフで表示することもできます。',
        ...
        },
        {
          ...
          description: 'Felica機能を使った入退室管理アプリです。Firebaseを使って開閉の管理をし、Flutterで在室かどうかを確認できるようにしています。',
        ...
        },
        {
          ...
          title: 'Muscle Blazer',
          assets: 'M5Stack',
          description: 'Superhuman Sports Design Challengeという学会に向けて製作した人工筋肉による触覚フィードバック付きの赤外線サバゲーです。HTC VIVEを用いたVRバージョンも製作し、CEDEC2018で展示しました。共同製作者：Antonio Vega Ramirez, Swagata Das, Chetan Thakur',
        ...
        },
        {
          ...
          description: 'シリコンバレー（ドラマ）をご存知の方なら知ってる、チェン・イェンのアプリです。TFLiteを使ってホットドッグの画像を学習させて、識別できるようにしました',
